//## 사용될 모들 정의
angular.module('myBoardApp', ['mBoardRouting', 'mBoardPagination','mBoardList','mBoardView','mBoardEdit','mBoardWrite']);

//## Servive Module 정의
var mGlobalService = angular.module('mGlobalService', []);

//-----------------------------------------------------------------------------
mGlobalService.factory('mGlobalServiceData', function(){
    return  {
        msgDatas:[],
...
//-----------------------------------------------------------------------------
mGlobalService.factory('myHttpService', function($http, mGlobalServiceData){
    return {
        ...
        getPagedList : function(page, listPerPage) {
            $http.get('/apis/list/'+page+'/'+listPerPage)
                .success(function(data) {
                    ...
                    angular.copy(data, mGlobalServiceData.msgDatas);
                });
        },
        view : function(id) {
